...
public class Company {
    ...
    public void hire(String id, String name, String jobTitle,
        ...
        if (employeeMap.containsKey(id)) {
            throw new EntityAlreadyExistsException(
                    "model.Employee is already registered.");
        }
    ...
    public Employee findEmployeeById(String id) {
        ...
        if (employee == null) {
            throw new EntityNotFoundException("model.Employee is not registered.");
        }
        return employee;
    }
...
// Deixei no projeto coisas antigas para casos de testes
