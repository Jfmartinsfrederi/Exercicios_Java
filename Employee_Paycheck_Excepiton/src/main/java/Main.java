...
public class Main {
    public static void main(String[] args) {
        ...
        // Serviços
        HiringService hiringService = new HiringService(repository);
